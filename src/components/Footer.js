export const Footer = () => {
  return (
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 text-yellow-400">
      ...
      <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row text-gray-500">
